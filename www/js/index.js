        ...
        //FUnciones sobre el html
            //$(document).ready(function(e) {
                ...
                $("#submitbutton").click(function() {
                    ...
                    var url = 'http://hbflix.tk//api/login/'+email+'/'+pass;
                    $.ajax({
                        type: "GET",
                        url:url,
                        dataType: 'json',
...
function series(){
    var url = 'http://hbflix.tk//api/verSeries';
    $.ajax({
        type: "GET",
        url:url,
        dataType: 'json',
        ...
        if ( console && console.log ) {
            //Estrenos
            document.getElementById("estrenos1").innerHTML = "<div class='row' style='margin-left: 5%;'><div class='hijo' style=' '><div class='portada-p'><img src='http://hbflix.tk/series/imgSeries/"+data["estrenos"][0]["titulo"]+"'style='height: 120px; border-radius: 8px;'></br></br><a href='/inicio/verPelicula/'><p style='color:  #EC67A2;''>"+data["estrenos"][0]["titulo"]+"</p></a><span style='color:  #EC67A2; text-align: center;'>"+data["estrenos"][0]["aLanzamiento"]+"</span></div></div>";
            document.getElementById("estrenos2").innerHTML = "<div class='row' style='margin-left: 5%;'><div class='hijo' style=''><div class='portada-p'><img src='http://hbflix.tk/series/imgSeries/"+data["estrenos"][1]["titulo"]+"'style='height: 120px; border-radius: 8px;'></br></br><a href='/inicio/verPelicula/'><p style='color:  #EC67A2;''>"+data["estrenos"][1]["titulo"]+"</p></a><span style='color:  #EC67A2; text-align: center;'>"+data["estrenos"][1]["aLanzamiento"]+"</span></div></div>";
            document.getElementById("estrenos3").innerHTML = "<div class='row' style='margin-left: 5%;'><div class='hijo' style=''><div class='portada-p'><img src='http://hbflix.tk/series/imgSeries/"+data["estrenos"][2]["titulo"]+"'style='height: 120px; border-radius: 8px;'></br></br><a href='/inicio/verPelicula/'><p style='color:  #EC67A2;''>"+data["estrenos"][2]["titulo"]+"</p></a><span style='color:  #EC67A2; text-align: center;'>"+data["estrenos"][2]["aLanzamiento"]+"</span></div></div>";
            document.getElementById("estrenos4").innerHTML = "<div class='row' style='margin-left: 5%;'><div class='hijo' style=''><div class='portada-p'><img src='http://hbflix.tk/series/imgSeries/"+data["estrenos"][3]["titulo"]+"'style='height: 120px; border-radius: 8px;'></br></br><a href='/inicio/verPelicula/'><p style='color:  #EC67A2;''>"+data["estrenos"][3]["titulo"]+"</p></a><span style='color:  #EC67A2; text-align: center;'>"+data["estrenos"][3]["aLanzamiento"]+"</span></div></div>";
            //Favoritos
            document.getElementById("fav1").innerHTML = "<div class='row' style='margin-left: 5%;'><div class='hijo' style=' '><div class='portada-p'><img src='http://hbflix.tk/series/imgSeries/"+data["favoritos"][0]["titulo"]+"'style='height: 120px; border-radius: 8px;'></br></br><a href='/inicio/verPelicula/'><p style='color:  #EC67A2;''>"+data["favoritos"][0]["titulo"]+"</p></a><span style='color:  #EC67A2; text-align: center;'>"+data["favoritos"][0]["aLanzamiento"]+"</span></div></div>";
            document.getElementById("fav2").innerHTML = "<div class='row' style='margin-left: 5%;'><div class='hijo' style=''><div class='portada-p'><img src='http://hbflix.tk/series/imgSeries/"+data["favoritos"][1]["titulo"]+"'style='height: 120px; border-radius: 8px;'></br></br><a href='/inicio/verPelicula/'><p style='color:  #EC67A2;''>"+data["favoritos"][1]["titulo"]+"</p></a><span style='color:  #EC67A2; text-align: center;'>"+data["favoritos"][1]["aLanzamiento"]+"</span></div></div>";
            document.getElementById("fav3").innerHTML = "<div class='row' style='margin-left: 5%;'><div class='hijo' style=''><div class='portada-p'><img src='http://hbflix.tk/series/imgSeries/"+data["favoritos"][2]["titulo"]+"'style='height: 120px; border-radius: 8px;'></br></br><a href='/inicio/verPelicula/'><p style='color:  #EC67A2;''>"+data["favoritos"][2]["titulo"]+"</p></a><span style='color:  #EC67A2; text-align: center;'>"+data["favoritos"][2]["aLanzamiento"]+"</span></div></div>";
            document.getElementById("fav4").innerHTML = "<div class='row' style='margin-left: 5%;'><div class='hijo' style=''><div class='portada-p'><img src='http://hbflix.tk/series/imgSeries/"+data["favoritos"][3]["titulo"]+"'style='height: 120px; border-radius: 8px;'></br></br><a href='/inicio/verPelicula/'><p style='color:  #EC67A2;''>"+data["favoritos"][3]["titulo"]+"</p></a><span style='color:  #EC67A2; text-align: center;'>"+data["favoritos"][3]["aLanzamiento"]+"</span></div></div>";
            //Favoritos2
            document.getElementById("fav5").innerHTML = "<div class='row' style='margin-left: 5%;'><div class='hijo' style=' '><div class='portada-p'><img src='http://hbflix.tk/series/imgSeries/"+data["favoritos"][4]["titulo"]+"'style='height: 120px; border-radius: 8px;'></br></br><a href='/inicio/verPelicula/'><p style='color:  #EC67A2;''>"+data["favoritos"][4]["titulo"]+"</p></a><span style='color:  #EC67A2; text-align: center;'>"+data["favoritos"][4]["aLanzamiento"]+"</span></div></div>";
            document.getElementById("fav6").innerHTML = "<div class='row' style='margin-left: 5%;'><div class='hijo' style=''><div class='portada-p'><img src='http://hbflix.tk/series/imgSeries/"+data["favoritos"][5]["titulo"]+"'style='height: 120px; border-radius: 8px;'></br></br><a href='/inicio/verPelicula/'><p style='color:  #EC67A2;''>"+data["favoritos"][5]["titulo"]+"</p></a><span style='color:  #EC67A2; text-align: center;'>"+data["favoritos"][5]["aLanzamiento"]+"</span></div></div>";
            document.getElementById("fav7").innerHTML = "<div class='row' style='margin-left: 5%;'><div class='hijo' style=''><div class='portada-p'><img src='http://hbflix.tk/series/imgSeries/"+data["favoritos"][6]["titulo"]+"'style='height: 120px; border-radius: 8px;'></br></br><a href='/inicio/verPelicula/'><p style='color:  #EC67A2;''>"+data["favoritos"][6]["titulo"]+"</p></a><span style='color:  #EC67A2; text-align: center;'>"+data["favoritos"][6]["aLanzamiento"]+"</span></div></div>";
            document.getElementById("fav8").innerHTML = "<div class='row' style='margin-left: 5%;'><div class='hijo' style=''><div class='portada-p'><img src='http://hbflix.tk/series/imgSeries/"+data["favoritos"][7]["titulo"]+"'style='height: 120px; border-radius: 8px;'></br></br><a href='/inicio/verPelicula/'><p style='color:  #EC67A2;''>"+data["favoritos"][7]["titulo"]+"</p></a><span style='color:  #EC67A2; text-align: center;'>"+data["favoritos"][7]["aLanzamiento"]+"</span></div></div>";
            //Ultimas agregadas
            document.getElementById("ult1").innerHTML = "<div class='row' style='margin-left: 5%;'><div class='hijo' style=' '><div class='portada-p'><img src='http://hbflix.tk/http://hbflix.tk/a["ultimas"][0]["titulo"]+"'style='height: 120px; border-radius: 8px;'></br></br><a href='/inicio/verPelicula/'><p style='color:  #EC67A2;''>"+data["ultimas"][0]["titulo"]+"</p></a><span style='color:  #EC67A2; text-align: center;'>"+data["ultimas"][0]["aLanzamiento"]+"</span></div></div>";
            document.getElementById("ult2").innerHTML = "<div class='row' style='margin-left: 5%;'><div class='hijo' style=''><div class='portada-p'><img src='http://hbflix.tk/http://hbflix.tk/a["ultimas"][1]["titulo"]+"'style='height: 120px; border-radius: 8px;'></br></br><a href='/inicio/verPelicula/'><p style='color:  #EC67A2;''>"+data["ultimas"][1]["titulo"]+"</p></a><span style='color:  #EC67A2; text-align: center;'>"+data["ultimas"][1]["aLanzamiento"]+"</span></div></div>";
            document.getElementById("ult3").innerHTML = "<div class='row' style='margin-left: 5%;'><div class='hijo' style=''><div class='portada-p'><img src='http://hbflix.tk/http://hbflix.tk/a["ultimas"][2]["titulo"]+"'style='height: 120px; border-radius: 8px;'></br></br><a href='/inicio/verPelicula/'><p style='color:  #EC67A2;''>"+data["ultimas"][2]["titulo"]+"</p></a><span style='color:  #EC67A2; text-align: center;'>"+data["ultimas"][2]["aLanzamiento"]+"</span></div></div>";
            document.getElementById("ult4").innerHTML = "<div class='row' style='margin-left: 5%;'><div class='hijo' style=''><div class='portada-p'><img src='http://hbflix.tk/http://hbflix.tk/a["ultimas"][3]["titulo"]+"'style='height: 120px; border-radius: 8px;'></br></br><a href='/inicio/verPelicula/'><p style='color:  #EC67A2;''>"+data["ultimas"][3]["titulo"]+"</p></a><span style='color:  #EC67A2; text-align: center;'>"+data["ultimas"][3]["aLanzamiento"]+"</span></div></div>";
